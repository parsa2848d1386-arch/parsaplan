                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="text-center">
                        <div className="flex flex-col items-center">
                            <span className="text-xs text-gray-400 dark:text-gray-500 font-medium mb-1">روز {currentDay} از {TOTAL_DAYS}</span>
                    ...
                    <button onClick={() => setCurrentDay(currentDay + 1)} disabled={currentDay === TOTAL_DAYS} className="w-10 h-10 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 disabled:opacity-30 hover:bg-indigo-50 dark:hover:bg-gray-600 hover:text-indigo-600 transition flex items-center justify-center active:scale-95">
                        <ChevronLeft size={20} />
                    </button>
                </div>
