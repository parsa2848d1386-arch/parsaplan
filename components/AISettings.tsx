...
**Force Persian language in 'message' field.**`;
    ...
    return createPortal(
        <>
            ...
            {/* MAIN AI SETTINGS MODAL */}
            {/* MAIN AI SETTINGS MODAL */}
            <div className="fixed inset-0 flex items-center justify-center p-4 md:p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200" style={{ zIndex: 2147483647 }}>
                <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] md:rounded-3xl shadow-2xl w-full max-w-6xl h-[60vh] md:h-[90vh] flex overflow-hidden animate-in zoom-in-95 duration-300 border border-gray-200 dark:border-gray-800 ring-1 ring-white/10 mb-32 md:mb-0">
