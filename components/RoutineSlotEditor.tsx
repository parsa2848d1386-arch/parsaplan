...
export const RoutineSlotEditor: React.FC<RoutineSlotEditorProps> = ({
    ...
    return createPortal(
        <div className="fixed inset-0 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200" style={{ zIndex: 9999 }}>
            <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] sm:rounded-3xl shadow-2xl w-full max-w-md max-h-[75vh] sm:max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-300 border border-gray-100 dark:border-gray-700">
