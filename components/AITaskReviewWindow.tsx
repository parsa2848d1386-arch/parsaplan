...
const AITaskReviewWindow: React.FC<AITaskReviewWindowProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200" style={{ zIndex: 9999 }}>
            <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] sm:rounded-3xl shadow-2xl w-full max-w-2xl max-h-[75vh] sm:max-h-[85vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300 border border-gray-200 dark:border-gray-800">
                {/* Header */}
